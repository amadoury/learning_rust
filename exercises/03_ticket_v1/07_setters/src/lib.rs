...
impl Ticket {
    pub fn new(title: String, description: String, status: String) -> Ticket {
        Ticket::has_good_title(&title);
        Ticket::has_good_description(&description);
        Ticket::has_good_status(&status);
    ...
    fn has_good_title(title: &String) {
        if title.is_empty() {
    ...
    fn has_good_description(description: &String) { 
    ...
    fn has_good_status(status: &String) {
